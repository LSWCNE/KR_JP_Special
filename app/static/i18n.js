...
const I18N = {
  ko: {
    ...
    "admin.categories_hint": "카테고리 이름, 매칭 키워드(설문 문항에 이 단어가 포함되면 해당 카테고리로 분류), 채팅창에 보여줄 예시 질문을 수정할 수 있습니다.",
    "admin.cat_th_key": "key",
    "admin.cat_th_ko": "한국어 이름",
    "admin.cat_th_ja": "일본어 이름",
    "admin.cat_th_keywords": "매칭 키워드 (콤마로 구분)",
  ...
  ja: {
    ...
    "admin.categories_hint": "カテゴリー名、マッチングキーワード(設問にこの単語が含まれる場合そのカテゴリーに分類)、チャット画面に表示する例文を編集できます。",
    "admin.cat_th_key": "key",
    "admin.cat_th_ko": "韓国語名",
    "admin.cat_th_ja": "日本語名",
    "admin.cat_th_keywords": "マッチングキーワード(カンマ区切り)",
