...
const I18N = {
  ko: {
    ...
    "admin.categories_hint": "카테고리 이름과 채팅창에 보여줄 예시 질문을 수정할 수 있습니다. (카테고리 종류 자체는 설문 문항과 연결되어 있어 추가/삭제는 지원하지 않습니다)",
  ...
  ja: {
    ...
    "admin.categories_hint": "カテゴリー名とチャット画面に表示する例文を編集できます。(カテゴリーの種類自体はアンケート項目と紐づいているため追加・削除には対応していません)",
