...
const I18N = {
  ko: {
    ...
    "chat.not_published": "아직 채팅 서비스가 준비 중입니다. 조금만 기다려주세요.",
    "chat.preview_banner": "⚠ 아직 게시되지 않았습니다. 지금은 관리자에게만 보이는 미리보기 화면입니다.",

    "admin.title": "데이터 관리 대시보드",
    "admin.subtitle": "구글 시트 동기화 상태와 응답 통계를 확인하고, 채팅 카테고리를 관리합니다.",
    "admin.publish_section_title": "채팅 게시",
    "admin.publish_hint": "게시하기 전까지는 일반 사용자에게 AI 채팅이 \"준비 중\" 화면으로만 보이고 실제로 사용할 수 없습니다. 관리자는 게시 여부와 상관없이 항상 미리보기로 사용할 수 있습니다.",
    "admin.publish_status_on": "현재 상태: 게시됨 (사용자가 사용할 수 있습니다)",
    "admin.publish_status_off": "현재 상태: 게시되지 않음 (사용자에게는 준비 중 화면만 보입니다)",
    "admin.publish_btn": "게시하기",
    "admin.unpublish_btn": "게시 취소",
    ...
    "admin.cat_th_example_ko_1": "예시 질문 1(한국어)",
    "admin.cat_th_example_ja_1": "예시 질문 1(일본어)",
    "admin.cat_th_example_ko_2": "예시 질문 2(한국어)",
    "admin.cat_th_example_ja_2": "예시 질문 2(일본어)",
  ...
  ja: {
    ...
    "chat.not_published": "まだチャットサービスは準備中です。もう少しお待ちください。",
    "chat.preview_banner": "⚠ まだ公開されていません。現在は管理者にのみ見えるプレビュー画面です。",

    "admin.title": "データ管理ダッシュボード",
    "admin.subtitle": "Googleスプレッドシートの同期状況と回答統計を確認し、チャットカテゴリーを管理します。",
    "admin.publish_section_title": "チャットの公開",
    "admin.publish_hint": "公開するまでは、一般ユーザーにはAIチャットが「準備中」画面としてのみ表示され、実際には使用できません。管理者は公開状態に関係なく、常にプレビューとして利用できます。",
    "admin.publish_status_on": "現在の状態: 公開中(ユーザーが利用できます)",
    "admin.publish_status_off": "現在の状態: 未公開(ユーザーには準備中画面のみ表示されます)",
    "admin.publish_btn": "公開する",
    "admin.unpublish_btn": "公開を取り消す",
    ...
    "admin.cat_th_example_ko_1": "例文1(韓国語)",
    "admin.cat_th_example_ja_1": "例文1(日本語)",
    "admin.cat_th_example_ko_2": "例文2(韓国語)",
    "admin.cat_th_example_ja_2": "例文2(日本語)",
